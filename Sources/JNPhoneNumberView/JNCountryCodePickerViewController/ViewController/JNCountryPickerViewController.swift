...
@objc public class JNCountryPickerViewController: UIViewController {
    ...
    public override func loadView() {
        ...
        // Create nib
        let nib = UINib(nibName: "JNCountryPickerViewController", bundle: Bundle.module)
    ...
    private func setupCloseBarButtonItem() {
        ...
        // Init close image
        let closeImage = UIImage(named: "closeImageButton", in: Bundle.module, compatibleWith: nil)
